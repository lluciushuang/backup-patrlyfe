...
<body>
    <aside class="admin-sidebar">
        ...
        <nav class="admin-nav">
            <a href="{{ route('admin.dashboard') }}" class="nav-item {{ request()->routeIs('admin.dashboard') ? 'active' : '' }}">Analytics Dashboard</a>
            <a href="{{ route('admin.products.index') }}" class="nav-item {{ request()->routeIs('admin.products.*') ? 'active' : '' }}">Manajemen Produk</a>
            <a href="{{ route('admin.pos.index') }}" class="nav-item {{ request()->routeIs('admin.pos.*') ? 'active' : '' }}">POS Kasir</a>
            <a href="{{ route('admin.orders.index') }}" class="nav-item {{ request()->routeIs('admin.orders.*') ? 'active' : '' }}">Manajemen Pesanan</a>
            <a href="{{ route('admin.broadcasts.index') }}" class="nav-item {{ request()->routeIs('admin.broadcasts.*') ? 'active' : '' }}">Kirim Broadcast</a>
            <a href="{{ route('admin.users.index') }}" class="nav-item {{ request()->routeIs('admin.users.*') ? 'active' : '' }}">Manajemen Pengguna</a>
            <a href="{{ route('admin.reports.index') }}" class="nav-item {{ request()->routeIs('admin.reports.*') ? 'active' : '' }}">Laporan</a>
        </nav>
    </aside>
