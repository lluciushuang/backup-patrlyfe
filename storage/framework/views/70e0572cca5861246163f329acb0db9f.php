...
<div class="dashboard-grid">
    ...
    <div class="stat-card active" data-target="section-pesanan">
        ...
        <div class="stat-value"><?php echo e($pendingOrders->count()); ?></div>
    ...
    <div class="stat-card" data-target="section-stok">
        ...
        <div class="stat-value"><?php echo e($lowStockProducts->count() + $outOfStockProducts->count()); ?></div>
    ...
    <div class="stat-card" data-target="section-pelanggan">
        ...
        <div class="stat-value"><?php echo e($newCustomers->count()); ?></div>
...
<div id="section-pesanan" class="dashboard-detail-section active">
    <div class="section-header">
        ...
        <a href="<?php echo e(route('admin.orders.index')); ?>" class="btn btn-outline btn-sm">Lihat Semua Pesanan &rarr;</a>
    </div>
    <table class="dash-table">
        ...
        <tbody>
            ...
            <tr>
                <td style="font-family: var(--font-mono); color: #E8521A;">ORD-<?php echo e(str_pad($order->id, 3, '0', STR_PAD_LEFT)); ?></td>
                <td><?php echo e($order->user->name ?? 'N/A'); ?></td>
                <td>Rp <?php echo e(number_format($order->total_amount, 0, ',', '.')); ?></td>
                <td><span style="background: rgba(245,158,11,0.1); color: #f59e0b; padding: 2px 8px; border-radius: 4px; font-size: 0.8rem;"><?php echo e(ucfirst($order->status)); ?></span></td>
            </tr>
...
<div id="section-pendapatan" class="dashboard-detail-section">
    <div class="section-header">
        ...
        <a href="<?php echo e(route('admin.reports.index')); ?>" class="btn btn-outline btn-sm">Laporan Keuangan &rarr;</a>
    </div>
    <table class="dash-table">
        <thead><tr><th>Bulan</th><th>Total Pendapatan</th></tr></thead>
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $monthlyRevenue; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rev): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr><td><?php echo e(date('F Y', mktime(0, 0, 0, $rev->month, 1, $rev->year))); ?></td><td style="color: #22c55e;">Rp <?php echo e(number_format($rev->total, 0, ',', '.')); ?></td></tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<div id="section-stok" class="dashboard-detail-section">
    <div class="section-header">
        ...
        <a href="<?php echo e(route('admin.products.index')); ?>" class="btn btn-outline btn-sm">Manajemen Produk &rarr;</a>
    </div>
    <table class="dash-table">
        ...
        <tbody>
            ...
            <tr>
                <td style="font-family: var(--font-mono);"><?php echo e($product->item_code); ?></td>
                <td><?php echo e($product->name); ?></td>
                <td style="color: #ef4444; font-weight: bold;"><?php echo e($product->current_stock); ?> Pcs</td>
                <td><button class="btn btn-sm" style="background: #151513; border: 1px solid #333;" onclick="openQuickStockModal(<?php echo e($product->id); ?>, '<?php echo e(addslashes($product->name)); ?>')">+ Tambah</button></td>
            </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <?php endif; ?>
...
<div id="section-pelanggan" class="dashboard-detail-section">
    <div class="section-header">
        ...
        <a href="<?php echo e(route('admin.users.index')); ?>" class="btn btn-outline btn-sm">Lihat Semua Data &rarr;</a>
    </div>
    <table class="dash-table">
        <thead><tr><th>Tanggal Daftar</th><th>Nama</th><th>Email</th><th>Total Belanja</th></tr></thead>
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $newCustomers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr>
    ...
    <div class="widget-card" id="widget-info" data-id="widget-info">
        ...
        <div style="flex-grow: 1; display: flex; flex-direction: column; justify-content: center; gap: 1rem;">
            <div style="display: flex; justify-content: space-between; border-bottom: 1px dashed #333; padding-bottom: 0.5rem;">
                ...
                <span style="color: var(--off-white); font-family: var(--font-mono);"><?php echo e(\App\Models\Product::count()); ?></span>
            </div>
            <div style="display: flex; justify-content: space-between; border-bottom: 1px dashed #333; padding-bottom: 0.5rem;">
                <span style="color: var(--gray-mid);">Total Customer</span>
                <span style="color: var(--off-white); font-family: var(--font-mono);"><?php echo e(\App\Models\User::where('role', 'customer')->count()); ?></span>
            </div>
            <div style="display: flex; justify-content: space-between;">
                <span style="color: var(--gray-mid);">Total Pesanan</span>
                <span style="color: var(--off-white); font-family: var(--font-mono);"><?php echo e(\App\Models\Transaction::where('status', '!=', 'cancelled')->count()); ?></span>
            </div>
        </div>
    </div>
</div>
...
// --- 4. RENDER GRAFIK CHART.JS ---
    ...
    const monthlyLabels = <?php echo json_encode($monthlyRevenueLabels, 15, 512) ?>;
    ...
    const categoryLabels = <?php echo json_encode($salesByCategoryLabels, 15, 512) ?>;
    const categoryData = <?php echo json_encode($salesByCategoryData, 15, 512) ?>;
...
document.getElementById('quickStockForm').addEventListener('submit', function(e) {
    ...
    const url = '<?php echo e(route('admin.products.add-stock', ':id')); ?>'.replace(':id', productId);
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\lenna\Herd\partlyfe_satu\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>