...
.nav-search input::placeholder { color: var(--gray-mid); }
        ...
        .produk-img-wrap { aspect-ratio: 1 / 1; background: #1A1A16; border-radius: 2px; display: flex; align-items: center; justify-content: center; margin-bottom: 1.25rem; overflow: hidden; position: relative; }
