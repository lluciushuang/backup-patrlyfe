...
<?php $__env->startSection('title', 'Partlyfe — Home'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="hero" style="width: 100vw; position: relative; left: 50%; right: 50%; margin-left: -50vw; margin-right: -50vw; display: grid; grid-template-columns: 1fr 1fr;">
        ...
        <div class="hero-left" style="padding: 6rem 3rem 6rem 8rem;">
            ...
            <div class="hero-actions">
                <a href="<?php echo e(route('produk.index')); ?>" class="btn btn-primary btn-lg" style="padding: 1rem 2.5rem; font-size: 1rem; border-radius: 2px;">
                    Belanja Sekarang
                ...
                <a href="<?php echo e(route('kategori.index')); ?>" class="hero-link" style="margin-left: 1.5rem;">Lihat Kategori</a>
            </div>
            <div class="hero-stats">
                <div>
                    <div class="hero-stat-num"><?php echo e(number_format(\App\Models\Product::count())); ?>+</div>
    ...
    <section class="kategori section-home" style="width: 100vw; position: relative; left: 50%; right: 50%; margin-left: -50vw; margin-right: -50vw; padding: 6rem 8rem;">
        <div class="kategori-header">
            ...
            <a href="<?php echo e(route('kategori.index')); ?>" class="btn btn-outline btn-sm">Lihat Semua →</a>
        </div>

<div class="kategori-grid">
             <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
             <a href="<?php echo e(route('kategori.show', str()->slug($kat->name))); ?>" class="kategori-card">
                <div class="kategori-icon-wrap">
                    <?php if(str_contains(strtolower($kat->name), 'mesin')): ?>
                ...
                <div class="kategori-info">
                    <div class="kategori-name" style="color: var(--off-white);"><?php echo e($kat->name); ?></div>
                    <div class="kategori-count"><?php echo e($kat->products_count); ?> produk</div>
                </div>
...
<div class="produk-grid">
             ...
             <a href="<?php echo e(route('produk.show', $product->id)); ?>" class="prod-card">
                <div class="produk-brand"><?php echo e($product->brand); ?></div>
                <div class="produk-img-wrap">
                    ...
                    <?php if($product->images->count() > 0): ?>
                        <img src="<?php echo e(asset('storage/' . $product->images->first()->image_path)); ?>" alt="<?php echo e($product->name); ?>" style="width: 100%; height: 100%; object-fit: contain;">
                    <?php else: ?>
                ...
                <div class="produk-name" style="color: var(--off-white);"><?php echo e($product->name); ?></div>
                <div class="produk-spec">Stok: <?php echo e($product->current_stock); ?> <?php echo e($product->unit); ?></div>
                <div class="produk-footer">
                    <div>
                        <?php $price = $product->prices->where('price_level', 1)->first(); ?>
                        <?php if($product->base_price > ($price->price ?? 0)): ?>
                            <div class="produk-price-old">Rp <?php echo e(number_format($product->base_price, 0, ',', '.')); ?></div>
                        <?php endif; ?>
                        <div class="produk-price">Rp <?php echo e(number_format($price->price ?? 0, 0, ',', '.')); ?></div>
                    </div>
    ...
    <div class="promo-section" style="width: 100vw; position: relative; left: 50%; right: 50%; margin-left: -50vw; margin-right: -50vw; padding: 0 8rem 4rem;">
        <div class="promo-banner">
            ...
            <a href="<?php echo e(route('produk.index')); ?>" class="btn-promo">
                Klaim Promo Sekarang →
            </a>
        </div>
    </div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\lenna\Herd\partlyfe_satu\resources\views/home.blade.php ENDPATH**/ ?>