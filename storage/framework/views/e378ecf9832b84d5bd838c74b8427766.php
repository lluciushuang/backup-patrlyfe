...
<div class="page-wrapper">
    ...
    <div class="wishlist-container">
        <div class="breadcrumb">
            <a href="<?php echo e(route('home')); ?>">HOME</a> <span>/</span> WISHLIST
        </div>

    <div class="wishlist-header">
        <h1 class="wishlist-title">MY WISHLIST</h1>
        <span class="wishlist-count"><?php echo e($wishlists->count()); ?> ITEM<?php echo e($wishlists->count() !== 1 ? 'S' : ''); ?> SAVED</span>
    </div>
    ...
    <div class="empty-wishlist">
        ...
        <a href="<?php echo e(route('produk.index')); ?>" class="btn btn-primary">Jelajahi Produk</a>
    </div>
    <?php else: ?>
...
<?php
        ...
        ?>
        <div class="wish-card" id="wish-<?php echo e($item->id); ?>">
            <button class="wish-delete-trigger" onclick="removeFromWishlist(<?php echo e($item->id); ?>)" title="Hapus dari Wishlist">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
            </button>

            <a href="<?php echo e(route('produk.show', $item->product_id)); ?>" class="wish-img-area" style="text-decoration: none; color: inherit;">
            ...
            <div class="wish-body">
                <span class="wish-brand"><?php echo e($item->product->brand); ?></span>
                <a href="<?php echo e(route('produk.show', $item->product_id)); ?>" style="text-decoration: none; color: inherit;">
                    <h3 class="wish-name"><?php echo e($item->product->name); ?></h3>
                </a>

                <div class="wish-stock-status <?php echo e($isInStock ? 'in' : 'out'); ?>">
                    <span style="font-size: 8px;">●</span>
                    <?php echo e($isInStock ? 'Stok Tersedia (' . $item->product->current_stock . ' pcs)' : 'Stok Habis'); ?>
                ...
                <div class="wish-footer">
                    ...
                    ?>
                    <span class="wish-price">Rp <?php echo e(number_format($displayPrice, 0, ',', '.')); ?></span>
                    <?php if($tierPriceLevel > 1 && $displayPrice < $originalPrice): ?>
                    <div style="font-size: 0.65rem; color: var(--gray-mid); text-decoration: line-through; margin-top: 0.1rem;">Rp <?php echo e(number_format($originalPrice, 0, ',', '.')); ?></div>
                    <?php endif; ?>
                    <?php if($isInStock): ?>
                    <button class="wish-add-cart-btn" onclick="addWishlistToCart(<?php echo e($item->product_id); ?>)" title="Masukkan Keranjang">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\lenna\Herd\partlyfe_satu\resources\views/wishlist/index.blade.php ENDPATH**/ ?>